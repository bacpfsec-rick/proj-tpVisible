...
public class tpRunner extends JFrame
{
   ...
   JMenuItem itemVisibility = new JMenuItem("Visibility From a Given Point");
    JMenuItem tpVisibility = new JMenuItem("Generate 2P-visibility");
   ...
   VisibilityPolygon polyline = new VisibilityPolygon();
	...
	class ActionEventHandler implements ActionListener
	{
			public void actionPerformed (ActionEvent e)
			{
				...
				else if (arg=="Generate 2P-visibility") {
					System.out.println("JPG generated: C:/Result/result.jpg");
				}
			}
	}
